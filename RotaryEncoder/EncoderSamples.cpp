...
struct encoder *setupEncoderOriginal(int pin_a, int pin_b)
{
	...
	WiringPiISR(pin_a, INTERRUPT_EDGE_BOTH, updateEncodersOriginal);
	WiringPiISR(pin_b, INTERRUPT_EDGE_BOTH, updateEncodersOriginal);
...
{			
	...
	PinMode(pin_a, PINMODE_INPUT);
	PullUpDnControl(pin_a, PULLUPDN_UP);
	WiringPiISR(pin_a, INTERRUPT_EDGE_BOTH, updateEncodersTestOneSignal);
...
struct encoder* setupEncoderOptimalCpu(int pin_a, int pin_b)
{
	...
	PinMode(pin_b, PINMODE_INPUT);
	PullUpDnControl(pin_b, PULLUPDN_UP);
	WiringPiISR(pin_a, INTERRUPT_EDGE_BOTH, updateEncodersForPerformance);
